...
if ( ! defined( 'PRIME_PORTFOLIO_RESUME_BUNDLE_URL' ) ) {
    define( 'PRIME_PORTFOLIO_RESUME_BUNDLE_URL', esc_url( 'https://www.themeignite.com/products/wp-theme-bundle', 'prime-portfolio-resume') );
}
...
function prime_portfolio_resume_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Option', 'prime-portfolio-resume' ),
		'id'            => 'right-sidebar',
		'description'   => '',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Two', 'prime-portfolio-resume' ),
		'id'            => 'sidebar-2',
		'description'   => '',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
	...
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Three', 'prime-portfolio-resume' ),
		'id'            => 'sidebar-3',
		'description'   => '',
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
...
function prime_portfolio_resume_scripts() {
	...
	wp_style_add_data('prime-portfolio-resume-style', 'rtl', 'replace');
...
function prime_portfolio_resume_body_sidebar_classes( $classes ) {
    $prime_portfolio_resume_sidebar_position = get_theme_mod( 'prime_portfolio_resume_sidebar_position', 'right' );

    if ( $prime_portfolio_resume_sidebar_position === 'left' ) {
        $classes[] = 'sidebar-left';
    } elseif ( $prime_portfolio_resume_sidebar_position === 'right' ) {
        $classes[] = 'sidebar-right';
    } elseif ( $prime_portfolio_resume_sidebar_position === 'no-sidebar' ) {
        $classes[] = 'no-sidebar';
    }

    return $classes;
}
add_filter( 'body_class', 'prime_portfolio_resume_body_sidebar_classes' );