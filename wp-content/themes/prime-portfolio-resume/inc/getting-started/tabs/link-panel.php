...
<div class="panel-right">
	<div class="prime-portfolio-resume-button-container">
		...
		<a target="_blank" href="<?php echo esc_url( PRIME_PORTFOLIO_RESUME_BUNDLE_URL ); ?>" class="button button-primary solo2">
			<?php esc_html_e("BUY ALL THEMES", "prime-portfolio-resume"); ?>
		</a>
