...
function prime_portfolio_resume_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'prime_portfolio_resume_post_layout_section',
        array(
            'title' => esc_html__( 'Post Layout Settings', 'prime-portfolio-resume' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
        )
    );

    $wp_customize->add_setting('prime_portfolio_resume_post_layout_setting', array(
        'default'           => 'right-sidebar',
        'sanitize_callback' => 'prime_portfolio_resume_sanitize_post_layout',
    ));

    $wp_customize->add_control('prime_portfolio_resume_post_layout_setting', array(
        'label'    => __('Post Column Settings', 'prime-portfolio-resume'),
        'section'  => 'prime_portfolio_resume_post_layout_section',
        'settings' => 'prime_portfolio_resume_post_layout_setting',
        'type'     => 'select',
        'choices'  => array(
            'one-column'   => __('One Column', 'prime-portfolio-resume'),
            'right-sidebar'   => __('Right Sidebar', 'prime-portfolio-resume'),
            'left-sidebar'   => __('Left Sidebar', 'prime-portfolio-resume'),
            'three-column'   => __('Three Columns', 'prime-portfolio-resume'),
            'four-column'   => __('Four Columns', 'prime-portfolio-resume'),
        ),
    ));

     /** Post Layouts Ends */

         /** Sidebar Settings for pages & Post */
    $wp_customize->add_section(
        'prime_portfolio_resume_sidebar_settings',
        array(
            'title' => esc_html__( 'Sidebar Settings', 'prime-portfolio-resume' ),
            'priority' => 20,
            'capability' => 'edit_theme_options',
        )
    );
    ...
    $wp_customize->add_control('prime_portfolio_resume_sidebar_text_align', array(
        ...
        'section'  => 'prime_portfolio_resume_sidebar_settings',
   ...
   $wp_customize->add_setting('prime_portfolio_resume_single_post_align',array(
        'default' => 'left-align',
        'sanitize_callback' => 'prime_portfolio_resume_sanitize_single_post_align'
    ));
    $wp_customize->add_control('prime_portfolio_resume_single_post_align',array(
        'type' => 'select',
        'label' => __('Post Content Alignment','prime-portfolio-resume'),
        'section' => 'prime_portfolio_resume_post_settings',
        'choices' => array(
            'left-align' => __('Left Alignment','prime-portfolio-resume'),
            'right-align' => __('Right Alignment','prime-portfolio-resume'),
            'center-align' => __('Center Alignment','prime-portfolio-resume'),
        ),
    ) );
